              ...
              children: [
                    ...
                    children: [
                      ...
                      BouncyScale(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.logout_rounded, size: 20, color: AppColors.ink700),
                        ),
                      ),
                    ],
                  ),
                ...
                StaggeredSlideFade(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.babyBlue.withValues(alpha: 0.22),
                      borderRadius: AppTokens.radiusXl,
                      border: Border.all(color: AppColors.babyBlueSolid.withValues(alpha: 0.35)),
                      boxShadow: [
                        BoxShadow(
                          color: AppColors.babyBlue.withValues(alpha: 0.20),
                          blurRadius: 24,
